# Generated by Django 3.1.7 on 2022-05-12 15:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('rentproperty', '0002_remove_renthouseinfo_buyer_delete_houseinfoimage_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Renthouse', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Renthouseimage',
            fields=[
                ...
                ('Renthouse', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='image', to='rentproperty.renthouse')),
            ],
        ),
    ]
