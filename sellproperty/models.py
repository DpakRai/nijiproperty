...
class Sellhouse(models.Model):
    ...
    added_by = models.ForeignKey(User,on_delete=models.CASCADE, related_name='Sellhouse')
...
class Sellhouseimage(models.Model):
    image = models.ImageField(upload_to='house_picture')
    Sellhouse = models.ForeignKey(Sellhouse, on_delete=models.CASCADE, null=True, related_name='image')

    def __str__(self):
        return self.Sellhouse.title
