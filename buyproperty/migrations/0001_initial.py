    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_info', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='buyproperty.house_info')),
            ],
        ),
        migrations.AddField(
            model_name='house_info',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buyproperty.seller_info'),
        ),
    ]
