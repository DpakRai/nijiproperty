...
class House(models.Model):
    ...
    added_by = models.ForeignKey(User,on_delete=models.CASCADE, related_name='house')
...
class HouseImage(models.Model):
    ...
    house = models.ForeignKey(House, on_delete=models.CASCADE, null=True, related_name='image')
...
class Comment(models.Model):
    house = models.ForeignKey(House,on_delete=models.CASCADE,related_name='house_comments')
    commented_by = models.ForeignKey(User, default='', on_delete=models.CASCADE, related_name='user_comments')
    message = models.TextField(max_length=200)
    reply_of = models.ForeignKey('self', on_delete=models.CASCADE, default=None, null=True, blank=True, related_name='replies')
    created_on = models.DateTimeField(default=timezone.now)
    ...
    def __str__(self):
        return f'Comment {self.message} by {self.commented_by.username}'